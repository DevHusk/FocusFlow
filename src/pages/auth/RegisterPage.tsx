...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-bg flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="orb orb-pink w-[500px] h-[500px] -top-40 -right-40 animate-aurora-drift" />
      <div className="orb orb-teal w-[400px] h-[400px] -bottom-32 -left-32 animate-aurora-drift-2" />
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          {configured && (
            <>
              <button
                ...
                className="w-full h-11 flex items-center justify-center gap-3 bg-white/[0.06] hover:bg-white/[0.1] border border-white/[0.08] rounded-xl font-medium text-sm text-text transition-all"
              >
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-11 glass-light rounded-xl text-sm text-text placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/[0.15] transition-all"
                />
                <button
                  type="button"
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 mt-0.5 rounded border-white/[0.1] bg-white/[0.04] text-primary focus:ring-primary/30" />
