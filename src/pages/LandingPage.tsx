...
import {
  ...
  Zap, Shield, Globe, ArrowRight, CheckCircle2, Star,
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-bg">
      ...
      <nav className="fixed top-0 w-full z-50 glass">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold text-text">FocusFlow</span>
          </div>
          <div className="flex items-center gap-3">
            <Link to="/login" className="px-4 py-2 text-sm font-medium text-text-secondary hover:text-text transition-colors">
              Log in
            </Link>
            <Link to="/register" className="px-5 py-2 text-sm font-medium bg-primary hover:bg-primary-hover text-white rounded-xl transition-colors shadow-glow">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-7xl font-bold text-text leading-tight mb-6"
          >
            Study with
          ...
          >
            <Link
              to="/register"
              className="flex items-center gap-2 px-8 py-3.5 bg-primary hover:bg-primary-hover text-white rounded-xl font-semibold transition-all shadow-glow hover:shadow-glow text-base"
            >
              Start Studying Free
              <ArrowRight size={18} />
            </Link>
            <Link
              to="/dashboard"
              className="flex items-center gap-2 px-8 py-3.5 bg-bg-card border border-border hover:border-border-hover text-text-secondary hover:text-text rounded-xl font-medium transition-all text-base"
            >
              View Dashboard
            </Link>
          </motion.div>
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-text mb-4">Everything you need to focus</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((feature, i) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="p-6 rounded-2xl bg-bg-card border border-border hover:border-border-hover transition-all group"
              >
      ...
      <section className="py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="rounded-2xl bg-bg-card border border-border p-1"
          >
            <div className="rounded-xl bg-bg-elevated aspect-video flex items-center justify-center">
      ...
      <section className="py-20 px-4 sm:px-6 border-t border-border">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-3xl font-bold text-text mb-4">Loved by students worldwide</h2>
          </motion.div>
      ...
      <section className="py-24 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="p-10 sm:p-14 rounded-3xl bg-gradient-to-br from-primary/10 via-bg-card to-accent/10 border border-border"
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-text mb-4">Ready to study smarter?</h2>
            <p className="text-text-secondary mb-8 max-w-lg mx-auto">
              Join thousands of students who use FocusFlow to stay focused and achieve their goals.
            </p>
            <Link
              to="/register"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary hover:bg-primary-hover text-white rounded-xl font-semibold transition-all shadow-glow"
            >
      ...
      <footer className="py-10 px-4 sm:px-6 border-t border-border">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-text">FocusFlow</span>
          </div>
